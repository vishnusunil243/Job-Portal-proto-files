...
func (x *CompanySignupRequest) GetCategory() int32 {
	if x != nil {
		return x.Category
	}
	return 0
...
func (x *CompanySignupResponse) GetCategory() int32 {
	if x != nil {
		return x.Category
	}
	return 0
...
var file_company_proto_rawDesc = []byte{
	...
	0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08,
	...
	0x28, 0x05, 0x52, 0x08, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x22, 0x47, 0x0a, 0x13,
