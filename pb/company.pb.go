...
var file_company_proto_rawDesc = []byte{
	...
	0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x72, 0x0a, 0x14, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x6e, 0x79,
	...
	0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x67, 0x0a, 0x15, 0x43, 0x6f, 0x6d,
	...
	0x09, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x32, 0xa2, 0x01, 0x0a, 0x0e,
...
var file_company_proto_depIdxs = []int32{
	0, // 0: user.CompanyService.CompanySignup:input_type -> user.CompanySignupRequest
	2, // 1: user.CompanyService.CompanyLogin:input_type -> user.CompanyLoginRequest
	1, // 2: user.CompanyService.CompanySignup:output_type -> user.CompanySignupResponse
	1, // 3: user.CompanyService.CompanyLogin:output_type -> user.CompanySignupResponse
